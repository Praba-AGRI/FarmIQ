...
const WeatherCard = ({ weather, summary, alerts = [], onGenerateSummary, generatingSummary }) => {
  const { t } = useLanguage();

  const isPlaceholder = summary?.summaryToday?.includes('Click \'Generate\'');
      ...
      {summary && (
        <div className="card bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 shadow-md">
          <div className="flex items-center justify-between mb-5">
            <h3 className="text-lg font-semibold text-blue-900">Weather Summary</h3>
            {isPlaceholder && (
              <button
